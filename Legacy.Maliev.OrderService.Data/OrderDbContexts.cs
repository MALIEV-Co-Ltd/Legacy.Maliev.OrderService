...
public sealed class OrderDbContext(DbContextOptions<OrderDbContext> options) : DbContext(options)
{
    ...
    private static void Dates<T>(EntityTypeBuilder<T> e) where T : class { e.Property<DateTime?>("CreatedDate").HasColumnType("timestamp without time zone").HasDefaultValueSql("CURRENT_TIMESTAMP AT TIME ZONE 'UTC'"); e.Property<DateTime?>("ModifiedDate").HasColumnType("timestamp without time zone").HasDefaultValueSql("CURRENT_TIMESTAMP AT TIME ZONE 'UTC'"); }
}
